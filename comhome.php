                ...
                <div class="main-content-container container-fluid px-4">
                    ...
                    ?>
                       ...
                       <th>Company</th>
                         ...
                         <th>Launch date</th>
                        <th>Bounty minimum</th>      
                        <th>Bounty average</th>
                                       </tr>
                                     </thead>     <tbody>
                                                         <?php
                    ...
                    <td><?php echo $staff['comp_id']; ?></td>
                      <td><?php echo $staff['comp_name']; ?></td>
                                        <td><?php echo $staff['reports']; ?></td>
                                             <td><?php echo date('M j, Y', strtotime($staff['joining_date'])); ?>
                                                                    </td>
                                             <td><?php echo $staff['bounty_minimum']; ?></td>
                                             <td>
                            <?php echo $staff['bounty_average']; ?>
                                                      </td>
                                                      </tr>
                                                         <?php
                            }
